...
/******************************************************************************
 Define
******************************************************************************/
#define MAGNETOMETER_SLAVE_ADDR         (0b0011110<<1U)       /*To do: find the address from the datasheet ...*/
#define ACCELEROMETER_SLAVE_ADDR        (0b1101011<<1U)      /*To do: find the address from the datasheet ...*/
/******************************************************************************
 Global variables
******************************************************************************/
...
IMU_POLOLU_STS ImuPololuReadData( PIMU_POLOLU_DATA pData )
{
	...
	if( 0x03 == (g_aBuf[0] & 0x03) )
	{
		...
		/*To do: collect the pData->nGyroX/Y/Z and pData->nAcclX/Y/Z ...*/

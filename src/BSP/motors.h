...
#define PID_CONST_KP				0.5
#define PID_CONST_KI				0.5
...
#define MOTOR1_STOP()						M1_PWM_OUT_DIS();
#define MOTOR2_STOP()						M2_PWM_OUT_DIS();
#define MOTOR3_STOP()						M3_PWM_OUT_DIS();
#define MOTOR4_STOP()						M4_PWM_OUT_DIS();
/*****************************************************************************
 Type definition
******************************************************************************/
